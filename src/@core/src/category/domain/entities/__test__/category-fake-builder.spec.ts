import { CategoryFakeBuilder } from "../category.databuilder";
...
describe("CategoryFakerBuilder Unit Tests", () => {
  describe("unique_entity_id prop", () => {
    ...
    it("should throw error when any with methods has called", () => {
      expect(() =>
        faker["getValue"]("unique_entity_id")
      ).toThrow(
        new Error(
    ...
    test("withUniqueEntityId", () => {
      ...
      expect(faker["_unique_entity_id"]).toBe(
        uniqueEntityId
      );
    ...
    it("should pass index to unique_entity_id factory", () => {
      let mockFactory = jest
        .fn()
        .mockReturnValue(new UniqueEntityId());
      ...
      mockFactory = jest
        ...
        .mockReturnValue(new UniqueEntityId());
      const fakerMany =
        CategoryFakeBuilder.theCategories(2);
  ...
  describe("name prop", () => {
    ...
    test("withName", () => {
      ...
      expect((faker as any)["_name"]()).toBe("test name");
  ...
  describe("description prop", () => {
    ...
    it("should be a function", () => {
      expect(
        typeof faker["_description"] === "function"
      ).toBeTruthy();
    });
    ...
    test("withDescription", () => {
      ...
      expect($this).toBeInstanceOf(CategoryFakeBuilder);
      expect(faker["_description"]).toBe(
        "test description"
      );

      faker.withDescription(() => "test description");
      expect((faker as any)["_description"]()).toBe(
        "test description"
      );
    ...
    it("should pass index to description factory", () => {
      ...
      expect(categories[1].description).toBe(
        `test description 1`
      );
    });
  });
  ...
  describe("is_active prop", () => {
    ...
    it("should be a function", () => {
      expect(
        typeof faker["_is_active"] === "function"
      ).toBeTruthy();
    });
  ...
  describe("created_at prop", () => {
    ...
    it("should pass index to created_at factory", () => {
      ...
      const category = faker.build();
      expect(category.created_at.getTime()).toBe(
        date.getTime() + 2
      );
  ...
  it("should create a category", () => {
    ...
    expect(category.uniqueEntityId).toBeInstanceOf(
      UniqueEntityId
    );
    ...
    expect(category.uniqueEntityId.value).toBe(
