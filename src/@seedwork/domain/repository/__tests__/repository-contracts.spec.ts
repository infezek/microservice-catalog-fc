...
describe("Search Unit Tests", () => {
  describe("SearchParams Unit Tests", () => {
    test("page prop", () => {
      ...
      arrange.forEach((i) => {
        expect(
          new SearchParams({ page: i.page as any }).page
        ).toBe(i.expected);
      });
    });
    ...
    test("per_page prop", () => {
      ...
      arrange.forEach((i) => {
        expect(
          new SearchParams({ per_page: i.per_page as any })
            .per_page
        ).toBe(i.expected);
      });
    });
    ...
    test("sort prop", () => {
      ...
      arrange.forEach((i) => {
        expect(
          new SearchParams({ sort: i.sort as any }).sort
        ).toBe(i.expected);
      });
    });
    ...
    test("filter prop", () => {
      ...
      arrange.forEach((i) => {
        expect(
          new SearchParams({ filter: i.filter as any })
            .filter
        ).toBe(i.expected);
      });
    });
