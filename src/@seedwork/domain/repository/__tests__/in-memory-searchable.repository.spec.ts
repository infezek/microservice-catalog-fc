...
describe("InMemorySearchableRepository Unit Testes", () => {
  ...
  describe("applyFilter method", () => {
    it("should no filter items when filter param is null", async () => {
      ...
      const spyFilterMethod = jest.spyOn(
        items,
        "filter" as any
      );
  ...
  describe("applyPaginate method", () => {
    it("should paginate items", async () => {
      ...
      let itemsPaginated = await repository[
        "applyPaginate"
      ](items, 1, 2);
      ...
      itemsPaginated = await repository["applyPaginate"](
        items,
        2,
        2
      );
